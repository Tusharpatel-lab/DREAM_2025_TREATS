...
| **`deviant_genes.py`**                        | Implements deviance-based ranking and feature selection, identifying genes most deviant across pathological conditions or cell types.                                                                      |
...
| **`Submission_model*.json` / `.pkl`**         | Packaged model configurations and final trained models used for DREAM challenge submissions. Useful for inspection or re-running predictions.                                                              |
